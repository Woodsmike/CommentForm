...
namespace CommentForm.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProcedureID,Title,Priority,Details")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProcedureID,Title,Priority,Details")] Procedure procedure)
        {
            if (ModelState.IsValid)
            {
